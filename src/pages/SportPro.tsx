...
const SportPro = () => {
  const specs = [
    { label: "True Range", value: "120 km", icon: Navigation },
    { label: "Top Speed", value: "85 km/h", icon: Cpu },
    ...
    { label: "Braking Setup", value: "Front/Rear Drum", icon: RefreshCw },
  ];

  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        <title>Okoyama Sport Pro | Dynamic & Bold Electric Scooter</title>
        <meta name="description" content="Meet Okoyama Sport Pro. Dynamic styling, swift acceleration, and agile handling engineered for the urban athlete." />
      </Helmet>
      <Navbar />
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold leading-tight">
              Okoyama <span className="text-gradient-gold">Sport Pro</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Engineered for the urban athlete. The Sport Pro variant steps up performance with enhanced motor controllers, aggressive bold color styling, and agile cornering stability.
            </p>
          ...
          >
            ...
            <img
              src={sportPro}
              alt="Okoyama Sport Pro Electric Scooter"
      ...
      <section className="py-24 bg-card border-t border-b border-border">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Pro Performance Metrics</h2>
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Faster acceleration ramps and upgraded thermal dampening systems built for heavy traffic paths.
            </p>
          </div>
