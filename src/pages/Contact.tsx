  ...
  const infoItems = [
    {
      ...
      detail: "+91 1800 419 6699",
      sub: "Toll-Free • 9:00 AM - 7:00 PM",
      icon: Phone,
    },
    {
      title: "Email Channels",
      detail: "hello@okoyama.in",
      sub: "support@okoyama.in",
      icon: Mail,
    },
    {
      title: "Corporate Headquarters",
      detail: "Okoyama Towers, 4th Floor, Sector 3, HSR Layout, Bengaluru, KA 560102",
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input placeholder="John Doe" className="bg-secondary/20" required />
                  </div>
                  <div className="space-y-2">
