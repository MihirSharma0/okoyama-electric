...
const Truss = () => {
  const specs = [
    { label: "True Range", value: "115 km", icon: Navigation },
    { label: "Top Speed", value: "70 km/h", icon: Cpu },
    ...
    { label: "Braking Setup", value: "Combi-Braking Setup", icon: RefreshCw },
  ];

  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        <title>Okoyama Truss 2X | Stable & Comfort Electric Scooter</title>
        <meta name="description" content="Explore Okoyama Truss 2X. Engineered for unmatched balance, wide storage layout, and extreme road stability." />
      </Helmet>
      <Navbar />
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold leading-tight">
              Okoyama <span className="text-gradient-gold">Truss 2X</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Balanced for pure comfort and premium family safety. The Truss 2X chassis features symmetric weight distribution and a wider dual-seat floorboard layout, making urban cruising completely smooth.
            </p>
          ...
          >
            ...
            <img
              src={truss}
              alt="Okoyama Truss 2X Comfort Scooter"
      ...
      <section className="py-24 bg-card border-t border-b border-border">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Stability Specifications</h2>
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Symmetric heavy-duty suspensions combined with a responsive Combi-Braking safety layout.
            </p>
          </div>
