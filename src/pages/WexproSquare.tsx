...
const WexproSquare = () => {
  const specs = [
    { label: "True Range", value: "130 km", icon: Navigation },
    { label: "Top Speed", value: "80 km/h", icon: Cpu },
    { label: "Charge Time", value: "3 Hours", icon: Zap },
    { label: "Voltage Configuration", value: "60V Direct", icon: Shield },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        <title>Okoyama Wexpro Square | Modern Minimalism Electric Scooter</title>
        <meta name="description" content="Explore Okoyama Wexpro Square. Minimalist geometric styling, signature linear LED signatures, and robust electric ranges." />
      </Helmet>
      <Navbar />
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold leading-tight">
              Okoyama <span className="text-gradient-gold">Wexpro Square</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Boxy, bold, and absolutely beautiful. The Wexpro Square is crafted for urban trendsetters who value minimalist lines, flat-panel digital dashes, and linear signature LED headlights.
            </p>
          ...
          >
            ...
            <img
              src={wexproSquare}
              alt="Okoyama Wexpro Square Scooter"
      ...
      <section className="py-24 bg-card border-t border-b border-border">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Minimalist Specifications</h2>
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Equipped with linear LED panels, highly efficient cells, and rapid thermal dispersion frames.
            </p>
          </div>
