...
const Trigger3x = () => {
  const specs = [
    { label: "True Range", value: "140 km", icon: Navigation },
    { label: "Top Speed", value: "95 km/h", icon: Cpu },
    { label: "Charge Time", value: "3-4 Hours", icon: Zap },
    { label: "Voltage Configuration", value: "60V | 72V Peak", icon: Shield },
    { label: "Battery Chemistry", value: "Lithium Ion Cells", icon: Award },
    { label: "Braking Setup", value: "Dual Disc Hydraulic", icon: RefreshCw },
  ];

  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        <title>Okoyama Trigger 3x | High Performance Electric Scooter</title>
        <meta name="description" content="Explore Okoyama Trigger 3x. Ultimate electric torque, dual hydraulic disc brakes, and instant sports throttle response." />
      </Helmet>
      <Navbar />
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold leading-tight">
              Okoyama <span className="text-gradient-gold">Trigger 3x</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Experience the unmatched surge of electric torque. Built with custom-wound radial flux hub motors and dual hydraulic disc brakes, the Trigger 3x delivers an exhilarating sports-bike throttle feel.
            </p>
          ...
          >
            ...
            <img
              src={trigger3x}
              alt="Okoyama Trigger 3x Sports Scooter"
      ...
      <section className="py-24 bg-card border-t border-b border-border">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Sports Tuning Specs</h2>
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Equipped with dual disc brakes, 72V powertrain logic, and instantaneous throttle ramps.
            </p>
          </div>
