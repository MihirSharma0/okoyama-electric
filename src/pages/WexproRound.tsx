...
const WexproRound = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        <title>Okoyama Wexpro Round | Smooth Elegance Electric Scooter</title>
        <meta name="description" content="Explore Okoyama Wexpro Round. Retro charm combined with highly-advanced digital displays and swift silent commuting." />
      </Helmet>
      <Navbar />
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold leading-tight">
              Okoyama <span className="text-gradient-gold">Wexpro Round</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Curves that turn heads. The Wexpro Round blends classic curves and retro charm with highly-responsive electric powertrains and modern integrated digital instrument clusters.
            </p>
          ...
          >
            ...
            <img
              src={wexproRound}
              alt="Okoyama Wexpro Round Scooter"
      ...
      <section className="py-24 bg-card border-t border-b border-border">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Elegant Specifications</h2>
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Equipped with a vivid digital cluster, zero-noise direct drives, and advanced cell packaging.
            </p>
          </div>
